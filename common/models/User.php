...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    /**
     * Finds user by url_name
     *
     * @param $url_name
     * @return static|null
     */
    public static function findByUrlname($url_name)
    {
        return static::findOne(['url_name' => $url_name, 'status' => self::STATUS_ACTIVE]);
    }
