...
class Bootstrap4LinkPager extends LinkPager
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->nextPageLabel = Yii::t('app', '&raquo;');
        $this->prevPageLabel = Yii::t('app', '&laquo;');
    ...
    public function run()
    {
        ...
        if ($this->pagination->getPageCount() > 1) {
            echo Html::tag('nav', $this->renderPageButtons(), ['class' => 'myPagination']);
        }
    }
